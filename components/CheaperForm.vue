<template>
    <div class="cheaper_block">
      <div class="container">
        <div class="cheaper_mini_title">Нашли дешевле у другого дилера?</div>
        <div class="cheaper_big_title">
          Мы вернём разницу <br /> с дополнительной скидкой <span>50 000</span> руб.
        </div>
