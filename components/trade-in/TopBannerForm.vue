<template>
    <div class="top_credit top_tradein">
        <div class="container">
          <div class="top_credit_middle">Выгодный Trade-in</div>
          <div class="top_credit_big">Скидка до 200 000 рублей</div>
  
          <form @submit.prevent="submitForm" @keydown.enter="submitForm" class="sendform">
            <div class="top_credit_form_first">
                <input type="hidden" name="utm" value="tradein_form">
