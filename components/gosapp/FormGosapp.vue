<template>
    <form class="sendform" @submit.prevent="submitForm" @keydown.enter="submitForm">
        <input type="hidden" name="utm" value="contacts_form">
          ...
          <div class="cheaper_form">
            ...
            <div class="wrap_input wrap_input_phone">
          ...
          <div>
            <div class="form_legacy">
              <label class="checkbox-elem">
                ...
                Я принимаю условия <nuxt-link :to="policyUrl"  class="privacy_but">"Пользовательского соглашения"</nuxt-link> и даю свое согласие на обработку моих персональных данных, а также ознакомлен с условиями продажи и финансовых программ.
