<template>
    <form @submit.prevent="submitForm" @keydown.enter="submitForm" class="sendform">
          ...
          <div>
            <textarea v-model="formData.comment" cols="30" rows="10" placeholder="Сообщение"></textarea>
          </div>
          <div class="wrap_input">
          ...
          <div>
            <label class="form_legacy_credit_page">
              ...
              <p>
                Я принимаю условия 
                <nuxt-link :to="policyUrl" class="privacy_but">"Пользовательского соглашения"</nuxt-link>
              </p>
            </label>
          </div>
        </form>
